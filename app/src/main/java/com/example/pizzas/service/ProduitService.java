package com.example.pizzas.service;
import com.example.pizzas.R;
import com.example.pizzas.classes.Produit;
import com.example.pizzas.dao.IDao;
...
public class ProduitService implements IDao<Produit> {
    ...
    private void seed() {
        ...
        ps.create(new Produit(
                ...
                "Préparer la pâte, ajouter les ingrédients, cuire"
        ));
        ps.create(new Produit(
                "Pizza Pepperoni",
                2,
                ...
                "25 min",
                "Fromage, pepperoni",
                "Pizza très populaire",
                "Assembler, cuire au four"
        ));
        ps.create(new Produit(
                "Pizza Fromage",
                3,
